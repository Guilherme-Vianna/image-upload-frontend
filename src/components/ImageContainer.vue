  ...
  >
    ...
    <div class="flex gap-6 items-center">
      <div
        ...
        class="loading-spinner text-blue-500"
      ></div>
      <div
        v-if="loading === ELoadingStatus.SUCCESS"
        class="pi pi-check text-white bg-green-500 rounded-full p-2"
      ></div>
      <div
        v-if="loading === ELoadingStatus.ERROR"
        class="pi pi-ban text-white bg-red-500 rounded-full p-2"
      ></div>
      ...
      >
        <div class="pi pi-share-alt mr-2">
          <div v-if="!isClicked">Compartilhar</div>
          <div v-if="isClicked">Copiado!</div>
        </div>
      </button>
      <button
        v-if="loading === ELoadingStatus.LOADING"
